...
def modeltranslation_editor_css():
    css_files = [
        'wagtail_modeltranslation/css/modeltranslation_editor.css',
    ]
    ...
    return css_includes  # + hook_output('insert_modeltranslation_css')


@hooks.register('insert_editor_js')
def modeltranslation_editor_js():
    js_files = [
    ...
    return format_html(js_languages) + js_includes  # + hook_output('insert_modeltranslation_js')
